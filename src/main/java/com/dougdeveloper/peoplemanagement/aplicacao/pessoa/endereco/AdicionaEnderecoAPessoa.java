...
/**
 * A classe <b>AdicionaEnderecoAPessoa</b> define um usecase para adicionar um endereço a uma <b>Pessoa</b>, passando
 * como parâmetros ao método adicionar o id da pessoa e um objeto do tipo <b>DadosCriarEndereco</b>
...
public class AdicionaEnderecoAPessoa {
	...
	public AdicionaEnderecoAPessoa(PessoaRepository repository) {
