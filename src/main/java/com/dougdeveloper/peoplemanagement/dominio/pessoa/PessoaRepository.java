...
/**
 * A interface <b>PessoaRepository</b> define os métodos a serem implementados
 * pela camada de infrastrutura referente a persistência de um objeto do tipo
 * <b>Pessoa</b> no banco de dados.
 * 
...
public interface PessoaRepository {
	...
	Page<Pessoa> buscarPorNome(String nome, Pageable paginacao);
