...
class RemoverEnderecoDaPessoaTest {
	...
	public void beforeEach() {
		...
		this.removerEnderecoDaPessoa = new RemoverEnderecoDaPessoa(repository);
	}
	...
	void deveriaRemoverUmEnderecoDeUmaPessoa() {
		...
		removerEnderecoDaPessoa.executar(1l, 1l);
	...
	void naoDeveriaTentarRemoverUmEnderecoDeUmaPessoaQueNaoExiste() {
		...
		assertThrows(ObjetoNaoEncontradoException.class, () -> removerEnderecoDaPessoa.executar(1l, Mockito.any()));
